...
This project is a basic **command-line interface (CLI) application** written in Python for managing student records. It allows users to perform **CRUD** (Create, Read, Update, Delete) operations on student data, which includes personal details and academic grades. The data is stored in a list of dictionaries in memory for the duration of the program's execution.

-----

## ✨ Features

  * **Add New Student:** Users can enter a student's name, Date of Birth (DOB), admission number, blood group, and grades for five subjects (Calculus, EEE, Physics, English, Computer Science).
...
##  Technologies/Tools Used
  ...
  * **Interface:** Command Line Interface (CLI) / Console Input/Output.
...
2.  ### **Testing Option 1: Add New Student**
      ...
      * Enter sample data for a student (e.g., Name: `Alice`, Admission No: `A101`, Grades: all `80`).
...
4.  ### **Testing Option 3: Edit Student Details**
      ...
      * Select **`1`** to edit the name. Enter a new name (e.g., `Alicia`).
      * The message `Details updated` should appear.
      * Use **Option 2** (View Student Details) to confirm the name has been updated to `Alicia`.
